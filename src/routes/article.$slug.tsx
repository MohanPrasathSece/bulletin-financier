...
export const Route = createFileRoute("/article/$slug")({
  ...
  notFoundComponent: () => (
    <div className="max-w-2xl mx-auto py-32 text-center px-6">
      <div className="eyebrow text-primary mb-3">Error 404</div>
    ...
    <article className="bg-background">
      ...
      <header className="max-w-3xl mx-auto px-6 pt-14 pb-8 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3 byline">
          <Link to="/author/$slug" params={{ slug: author.slug }} className="flex items-center gap-2">
            ...
            <span className="text-foreground font-medium">By {author.name}</span>
          </Link>
          <span>·</span>
      ...
      <figure className="max-w-6xl mx-auto px-6">
        ...
        <figcaption className="mt-3 text-xs text-muted-foreground italic text-center">
          Photograph: The Ledger Standard archive.
        </figcaption>
      </figure>
      ...
      <div className="max-w-[1400px] mx-auto px-6 mt-12 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8 lg:col-start-2">
          <div className="font-serif text-[19px] leading-[1.75] text-foreground">
            ...
            <h3 className="font-serif text-2xl font-bold mt-12 mb-4">A market in transition</h3>
            <p className="mb-6">
              The numbers tell only part of the story. Beneath the daily price ticks lies a slower-moving
              transformation: a new generation of intermediaries, custodians and benchmarks is being built,
              tested and, in many cases, quietly absorbed into the workflows of established institutions.
            </p>

            <ul className="font-sans text-base list-disc pl-6 mb-8 space-y-2 text-foreground/90">
              <li>Spot ETF assets under management have risen for a sixth consecutive month.</li>
              <li>Custody premia have narrowed sharply as regulated providers gain share.</li>
              <li>Tokenised treasury products now exceed $4.2bn in cumulative subscriptions.</li>
            </ul>
            ...
            <figure className="my-10">
              ...
              <figcaption className="mt-2 text-xs text-muted-foreground italic">
                Figure 1. Net weekly flows into U.S.-listed digital asset products, 12-week trailing.
              </figcaption>
            </figure>

            <p className="mb-6">
              What remains unsettled is the long-tail of the market — the thousands of smaller venues, tokens
              and protocols whose role in the next phase of institutional integration is far from clear.
            </p>
          </div>
          ...
          <section className="mt-14 border-t-[3px] border-double border-foreground pt-8 flex gap-5">
            ...
            <div>
              <div className="eyebrow text-primary">About the author</div>
          ...
          <section className="mt-14">
            <h3 className="eyebrow border-b-2 border-foreground pb-2 mb-5">Reader Comments · 24</h3>
            <div className="space-y-6">
              {[
                { name: "M. Halverson", text: "A measured, careful piece. The shift in custody quality is genuinely under-reported." },
                { name: "R. Iyengar", text: "Worth pairing this with last week's research note on tokenised treasuries." },
              ].map((c) => (
      ...
      <section className="max-w-[1400px] mx-auto px-6 mt-20">
        <h3 className="eyebrow border-b-2 border-foreground pb-2 mb-6">Related Stories</h3>
